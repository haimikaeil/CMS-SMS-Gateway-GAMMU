...
<head>
    <meta charset="utf-8" />
    <title>ERROR 404 | ENDQUEUE</title>
    ...
    <link href="<?= base_url() ?>/public/assets/template/assets/pages/css/error.min.css" rel="stylesheet" type="text/css" />
...
<body class=" page-404-3">
    <div class="page-inner">
        <img src="<?= base_url() ?>/public/assets/template/assets/pages/media/pages/earth.jpg" class="img-responsive" alt="">
    </div>
    <div class="container error-404">
        <h1>404</h1>
        <h2>Wah, sepertinya anda tersesat!</h2>
        <p>
            <a href="<?= site_url() ?>" class="btn red btn-outline"> Kembali ke Rumah </a>
            <br>
        </p>
    </div>
    <!--[if lt IE 9]>
